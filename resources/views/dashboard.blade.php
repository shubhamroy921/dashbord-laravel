...
@section('content')
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Boys</p>
                                <h5 class="font-weight-bolder mb-0">
                                    65
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Total girl</p>
                                <h5 class="font-weight-bolder mb-0">
                                  65
    ...
    <div class="card text-uppercase my-3 p-3 font-weight-bold">Our Staffs</div>
    <div class="row mt-3">
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
            <div class="card">
                <div class="card-body p-3">
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Male Staff</p>
                                <h5 class="font-weight-bolder mb-0">
                                  65
                                    <span class="text-success text-sm font-weight-bolder">+3%</span>
                                </h5>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Female Staff</p>
                                <h5 class="font-weight-bolder mb-0">
                                  65
                                    <span class="text-danger text-sm font-weight-bolder">-2%</span>
                                </h5>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Other</p>
                                <h5 class="font-weight-bolder mb-0">
                                    45
                                    <span class="text-success text-sm font-weight-bolder">+5%</span>
                                </h5>
