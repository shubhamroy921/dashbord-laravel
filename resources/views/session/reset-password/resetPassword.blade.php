                    ...
                    <div class="card-body">
                        <form role="form" action="/reset-password" method="POST">
                            ...
                            <div>
                                ...
                                <div class="">
                                    <input id="email" name="email" type="email" class="form-control" value="{{ old('email', $request->email) }}" placeholder="Email" aria-label="Email" aria-describedby="email-addon" readonly>
                                    @error('email')
