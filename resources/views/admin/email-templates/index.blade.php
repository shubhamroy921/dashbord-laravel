                                    ...
                                    @else
                                        @foreach ($products as $product)
                                            <tr data-id="{{ $product->id }}" class="draggable" draggable="true">
                                                ...
                                                <td class="text-center">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">{{ $product->created_at ? $product->created_at->format('d-m-Y') : '' }}</span>
                                                </td>
                                                <td class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0">{{ $product->sort }}</p>
                                                </td>
                                                <td class="text-center">
                                                    <a href="{{ route('admin.products.show', $product->id) }}?title={{ urlencode($product->title) }}"
                                                        class="" data-bs-toggle="tooltip"
                                                        data-bs-original-title="View Student">
                                                        <i class="fas fa-eye text-secondary"></i>
                                                    </a>
                                                    <a href="{{ route('admin.products.edit', $product->id) }}?title={{ urlencode($product->title) }}"
