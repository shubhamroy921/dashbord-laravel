                                ...
                                <div class="row m-0">
                                    <div class="col-7">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" id="title"
                                                value="{{ old('title', $page->title) }}" class="form-control">
                                            @error('title')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description" id="description" rows="3" class="form-control ckediter">{{ old('description', $page->description) }}</textarea>
                                            @error('description')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div id="block-container">
                                            @foreach (json_decode($page->blocks, true) as $index => $block)
                                                <div class="block mb-3 border p-3 position-relative">
                                                    <div class="d-flex justify-content-between mb-2">
                                                        <button type="button"
                                                            class="btn-secondary me-2 duplicate-block rounded-circle"><i
                                                                class="fas fa-clone fs-5"></i></button>
                                                        <button type="button"
                                                            class="btn-danger me-2 remove-block rounded-circle"><i
                                                                class="fas fa-times fs-5"></i></button>
                                                        <button type="button"
                                                            class="btn-info toggle-collapse rounded-circle"><i
                                                                class="fas fa-caret-up fs-5"></i></button>
                                                        <button type="button"
                                                            class="btn-secondary drag-handle rounded-circle"><i
                                                                class="fas fa-arrows-alt"></i></button>
                                                    </div>
                                                    <select class="form-control block-type-select mb-3" name="block_type[]">
                                                        <option value="">Select Block Type</option>
                                                        <option value="default"
                                                            {{ $block['type'] == 'default' ? 'selected' : '' }}>Default
                                                        </option>
                                                        <option value="image"
                                                            {{ $block['type'] == 'image' ? 'selected' : '' }}>Image Block
                                                        </option>
                                                        <option value="video"
                                                            {{ $block['type'] == 'video' ? 'selected' : '' }}>Video Block
                                                        </option>
                                                        <option value="gallery"
                                                            {{ $block['type'] == 'gallery' ? 'selected' : '' }}>Gallery
                                                            Block</option>
                                                        <option value="hero-section"
                                                            {{ $block['type'] == 'hero-section' ? 'selected' : '' }}>Hero
                                                            Section</option>
                                                        <option value="splitwithimage"
                                                            {{ $block['type'] == 'splitwithimage' ? 'selected' : '' }}>
                                                            Split with Image</option>
                                                        <option value="threecolumns"
                                                            {{ $block['type'] == 'threecolumns' ? 'selected' : '' }}>Three
                                                            Columns</option>
                                                    </select>
                                                    <input type="hidden" name="block_type[]" value="{{ $block['type'] }}">
                                                    <input type="hidden" name="block_id[]" value="{{ $block['id'] }}">
                                                    <div class="block-fields mt-3">
                                                        <div class="mb-3">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea class="form-control ckediter" name="block_description[]" rows="3">{{ $block['description'] ?? '' }}</textarea>
                                                        </div>
                                                        <div class="mb-3">
                                                        ...
                                                        @elseif ($block['type'] == 'gallery')
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="gallery-inputs">
                                                                    @foreach ($block['gallery_paths'] as $galleryPath)
                                                                        <div class="gallery-image-field mb-2">
                                                                            <input type="file" class="form-control"
                                                                                name="block_gallery[{{ $index }}][]"
                                                                                onchange="previewImage(event, this)">
                                                                            <button type="button"
                                                                                class="btn btn-danger btn-sm remove-image mt-2">Remove</button>
                                                                            <div class="image-preview mt-2">
                                                                ...
                                                                <button type="button"
                                                                    class="btn btn-secondary add-gallery-image">Add
                                                                    Image</button>
                                                            </div>
                                                        @elseif ($block['type'] == 'hero-section')
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ $block['hero_section_title'] ?? '' }}">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label">Hero Section Description</label>
                                                                <textarea class="form-control ckediter" name="hero_section_description[]" rows="3">{{ $block['hero_section_description'] ?? '' }}</textarea>
                                                            </div>
                                                            <div class="mb-3">
                                                        ...
                                                        @elseif ($block['type'] == 'splitwithimage')
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="split_with_image_title[]"
                                                                    value="{{ $block['split_with_image_title'] ?? '' }}">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label">Split with Image
                                                                    Description</label>
                                                                <textarea class="form-control ckediter" name="split_with_image_description[]" rows="3">{{ $block['split_with_image_description'] ?? '' }}</textarea>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label">Split with Image Image</label>
                                                                <input type="file" class="form-control"
                                                                    name="split_with_image_image[]"
                                                                    onchange="previewImage(event, this)">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-control"
                                                                    name="split_with_image_image_align[]">
                                                                    <option value="left"
                                                                        {{ $block['split_with_image_image_align'] == 'left' ? 'selected' : '' }}>
                                                                        Left</option>
                                                                    <option value="right"
                                                                        {{ $block['split_with_image_image_align'] == 'right' ? 'selected' : '' }}>
                                                                        Right</option>
                                                                </select>
                                                            </div>
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="split_with_image_button_text[]"
                                                                    value="{{ $block['split_with_image_button_text'] ?? '' }}">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label">Button Link</label>
                                                                <input type="text" class="form-control"
                                                                    name="split_with_image_button_link[]"
                                                                    value="{{ $block['split_with_image_button_link'] ?? '' }}">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label">Button Target</label>
                                                                <select class="form-control"
                                                                    name="split_with_image_button_target[]">
                                                                    <option value="_self"
                                                                        {{ $block['split_with_image_button_target'] == '_self' ? 'selected' : '' }}>
                                                                        Self</option>
                                                                    <option value="_blank"
                                                                        {{ $block['split_with_image_button_target'] == '_blank' ? 'selected' : '' }}>
                                                                        Blank</option>
                                                                </select>
                                                            </div>
                                                        @elseif ($block['type'] == 'threecolumns')
                                                            <div class="three-columns-items mt-3">
                                                                @foreach ($block['three_column_items'] as $item)
                                                                    <div class="three-column-item border p-3 mb-3"
                                                                        data-block-id="{{ $item['id'] }}">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Image</label>
                                                                            <input type="file" class="form-control"
                                                                                name="three_column_images[]"
                                                                                onchange="previewImage(event, this)">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                name="three_column_titles[]"
                                                                                value="{{ $item['title'] ?? '' }}">
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Description</label>
                                                                            <textarea class="form-control" name="three_column_descriptions[]" rows="3">{{ $item['description'] ?? '' }}</textarea>
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Button Link</label>
                                                                            <input type="text" class="form-control"
                                                                                name="three_column_links[]"
                                                                                value="{{ $item['button_link'] ?? '' }}">
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Button Text</label>
                                                                            <input type="text" class="form-control"
                                                                                name="three_column_button_texts[]"
                                                                                value="{{ $item['button_text'] ?? '' }}">
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Target</label>
                                                                            <select class="form-control"
                                                                                name="three_column_targets[]">
                                                                                <option value="_self"
                                                                                    {{ $item['target'] == '_self' ? 'selected' : '' }}>
                                                                                    Same Tab</option>
                                                                                <option value="_blank"
                                                                        ...
                                                                        <button type="button"
                                                                            ...
                                                                            data-block-id="{{ $item['id'] }}">Remove</button>
                                                                    </div>
                                                                @endforeach
                                                            </div>
                                                            <div class="mb-3 d-flex justify-content-end">
                                                                <button type="button"
                                                                    class="btn btn-primary add-three-column-item">Add
                                                                    items</button>
                                                            </div>
                                                        @endif
                                                    </div>
                                        ...
                                        <div class="mb-3 text-end">
                                            <button type="button" id="add-block" class="btn btn-primary">Add
                                                Block</button>
                                        </div>
                                    ...
                                    <div class="col-5">
                                        <div class="sidebar sticky-top fix">
                                            @include('components.rightsidebar', ['page' => $page])</div>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $(document).ready(function() {
                $(".three-columns-items").on("click", ".remove-item", function() {
                    let blockId = $(this).data("block-id");
                    $(this).closest(".three-column-item").remove();
                    let jsonData = yourJsonDataVariable;
                    yourJsonDataVariable = jsonData.filter(item => item.id !== blockId);

                    console.log("Updated JSON Data:", yourJsonDataVariable);
                });
            });
