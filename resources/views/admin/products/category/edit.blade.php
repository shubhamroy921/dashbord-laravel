                        ...
                        <div class="table-responsive p-0">
                            <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    @endif
                                    <input accept=".jpg,.jpeg,.png" type="file" name="image" id="image" class="form-control">
                                </div>
                                ...
                                <div class="mb-3">
                                 ...
                                 <div class="mb-3">
                                    ...
                                    <input type="number" name="sort" id="sort" value="{{ old('sort',$category->sort) }}"
                                        class="form-control">
                                    @error('sort')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                 ...
                                 <div class="mb-3 status d-flex align-items-center">
                                    ...
                                    <div class="check-box flex justify-center items-center mt-2 ms-5">
                                        <input id="status" type="checkbox" class="status-checkbox" name="status" value="1" {{ old('status', $category->status ?? 0) == 1 ? 'checked' : '' }}>
                                    </div>
                                    @error('status')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
