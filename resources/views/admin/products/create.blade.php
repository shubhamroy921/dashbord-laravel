                                ...
                                <div class="row justify-content-between">
                                    <div class="col-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description" id="description" rows="3" class="form-control ckeditor">{{ old('description') }}</textarea>
                                            @error('description')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="upload-container">
                                                ...
                                                <input type="file" name="images[]" id="images" multiple
                                                    class="form-control" onchange="previewImages()" hidden>
                                                @error('images')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="sell_price" id="sell_price"
                                                value="{{ old('sell_price') }}" class="form-control">
                                            @error('sell_price')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-3">
                                        ...
                                        <div class="mb-3 status d-flex align-items-center">
                                            ...
                                            <div class="check-box flex justify-center items-center mt-2 ms-5">
                                                <input id="status" type="checkbox" class="status-checkbox"
                                                    name="status" value="1"
