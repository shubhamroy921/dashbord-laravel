                ...
                <div class="card mb-4 mx-4">
                    ...
                    <div class="card-body px-0 pt-3 pb-2 mx-4">
                        <div class="table-responsive p-0">
                            <form action="{{ route('admin.menuitems.update', $menuitems->id) }}" method="POST"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="name" value="{{ old('name', $menuitems->name) }}"
                                        class="form-control">
                                    @error('name')
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <input type="text" name="link" id="link" value="{{ old('link', $menuitems->link) }}"
                                        class="form-control">
                                    @error('url')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="sort" id="sort" value="{{ old('sort', $menuitems->sort) }}"
                                        class="form-control">
                                    @error('sort')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3 status d-flex align-items-center">
                                    ...
                                    <div class="check-box flex justify-center items-center mt-2 ms-5">
                                        ...
                                        <input id="status" type="checkbox" class="status-checkbox" name="status"
                                            value="1" {{ old('status', $menuitems->status) == 1 ? 'checked' : '' }}>
                                    </div>
                                    @error('status')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
